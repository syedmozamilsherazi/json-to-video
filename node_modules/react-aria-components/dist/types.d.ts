...
export interface ColorSwatchPickerProps extends ValueBase<string | _Color1 | null, _Color1>, AriaLabelingProps, StyleRenderProps<ColorSwatchPickerRenderProps> {
 ...
 * and selection.
 */
export const UNSTABLE_Tree: <T extends object>(props: TreeProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>;
 ...
 */
export const UNSTABLE_TreeItem: <T extends object>(props: TreeItemProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>;
...
export function UNSTABLE_TreeItemContent(props: TreeItemContentProps): React.ReactElement<any, string | React.JSXElementConstructor<any>>;
