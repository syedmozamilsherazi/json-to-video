...
exports.frostedThemePlugin = exports.getColorDefinitions = exports.grayColorNames = exports.accentColorNames = void 0;
exports.getColorTokenName = getColorTokenName;
...
exports.accentColorNames = [];
exports.grayColorNames = [];
const frostedColorScales = 12;
theme_options_1.themeAccentColorsGrouped.map((group) => {
    exports.accentColorNames.push(...group.values.filter((color) => color !== 'gray'));
});
theme_options_1.themeGrayColorsGrouped.map((group) => {
    exports.grayColorNames.push(...group.values.filter((color) => color !== 'auto'));
});
...
exports.getColorDefinitions = getColorDefinitions;
exports.frostedThemePlugin = plugin_1.default.withOptions(() => {
    ...
    function generateTailwindColors(colorName) {
        const c = {
            ...(0, exports.getColorDefinitions)(colorName, false),
            ...(0, exports.getColorDefinitions)(colorName, true),
        };
        if (exports.grayColorNames.includes(colorName)) {
            c[`${getColorTokenName(2, false)}-translucent`] = `var(--${colorName}-2-translucent)`;
        }
        return c;
    }
    const allFrostedColors = [...exports.accentColorNames, ...theme_options_1.semanticColors, ...exports.grayColorNames].reduce((acc, colorName) => {
