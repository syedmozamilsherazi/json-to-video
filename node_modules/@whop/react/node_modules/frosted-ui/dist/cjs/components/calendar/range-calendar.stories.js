...
const meta = {
    ...
    component: __1.RangeCalendar,
    args: {
        defaultValue: {
            start: (0, date_1.parseDate)('2020-02-03'),
            end: (0, date_1.parseDate)('2020-02-08'),
        },
        onChange: (dateRange) => console.log(dateRange ? dateRange.start.toString() + ' - ' + dateRange.end.toString() : dateRange),
    },
    parameters: {
...
exports.Default = {
    ...
    render: (args) => (react_1.default.createElement("div", null,
        react_1.default.createElement(__1.RangeCalendar, { ...args, minValue: (0, date_1.parseDate)('1900-02-03') }))),
};
exports.Disabled = {
    args: {},
    render: (args) => (react_1.default.createElement("div", null,
        react_1.default.createElement(__1.RangeCalendar, { ...args, isDisabled: true }))),
};
exports.UnavailableDates = {
    ...
    render: (args) => {
        ...
        return (react_1.default.createElement("div", { style: { width: 300 } },
            react_1.default.createElement(__1.RangeCalendar, { ...args, minValue: (0, date_1.today)((0, date_1.getLocalTimeZone)()), isDateUnavailable: isDateUnavailable })));
    },
};
//# sourceMappingURL=range-calendar.stories.js.map