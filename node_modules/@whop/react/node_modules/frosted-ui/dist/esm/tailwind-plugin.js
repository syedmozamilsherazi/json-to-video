...
export function getColorTokenName(number, alpha) {
    return alpha ? 'a' + number : number;
}
export const getColorDefinitions = (color, alpha) => {
...
export const frostedThemePlugin = plugin.withOptions(() => {
    ...
    const allFrostedColors = [...accentColorNames, ...semanticColors, ...grayColorNames].reduce((acc, colorName) => {
