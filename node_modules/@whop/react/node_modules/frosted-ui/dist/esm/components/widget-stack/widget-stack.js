...
const WidgetStackRoot = ({ children, orientation = widgetStackRootPropDefs.orientation.default, autoPlay, ...props }) => {
...
const WidgetStackStack = (props) => {
    ...
    return (React.createElement("div", { ...rootProps, className: classNames('fui-WidgetStackStack', className), onMouseEnter: () => setIsHovering(true), onMouseLeave: () => setIsHovering(false) },
...
const WidgetStackItem = (props) => {
    ...
    return (React.createElement(WidgetStackItemContext.Provider, { value: { isFullyVisible } },
        React.createElement("div", { ...rootProps, ref: ref, className: classNames('fui-WidgetStackItem', className), role: "group", "aria-roledescription": "slide", "data-fully-visible": isFullyVisible ? 'true' : undefined, 
            // Disable focusing widget content when it's not fully visible
            // eslint-disable-next-line @typescript-eslint/ban-ts-comment
            // @ts-ignore
            inert: isFullyVisible ? undefined : '' },
            React.createElement("div", { className: classNames('fui-WidgetStackItemContent') }, children))));
};
WidgetStackItem.displayName = 'WidgetStackItem';
const WidgetStackNext = (props) => {
    const { nextDisabled, controls } = useWidgetStack();
    return (React.createElement(Slot.Root, { ...props, 
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore -- fix later
