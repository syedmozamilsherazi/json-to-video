...
import { Button, Heading, Kbd, ScrollArea, Text, Theme, Tooltip, dangerColors, getMatchingGrayColor, infoColors, radixGrayScalesDesaturated, successColors, themeAccentColorsOrdered, 
// helpers
themePropDefs, updateThemeAppearanceClass, useThemeContext, warningColors, } from './index';
...
const ThemePanelImpl = React.forwardRef((props, forwardedRef) => {
    ...
    return (React.createElement(Theme, { asChild: true },
        React.createElement("div", { 
            ...
            React.createElement(ScrollArea, null,
                React.createElement("div", { style: { position: 'relative', flexGrow: 1, padding: 24 } },
                    React.createElement("div", { style: { margin: 8, position: 'absolute', top: 0, right: 0 } },
                        React.createElement(Tooltip, { content: "Press \u2318\u2009C to show/hide the Theme Panel", side: "bottom", sideOffset: 6 },
                            React.createElement(Kbd, { size: "3", tabIndex: 0, className: "fui-ThemePanelShortcut" }, "\u2318\u2009C"))),
                    React.createElement(Heading, { size: "5", trim: "both", as: "h3", style: {
                            marginBottom: 24,
                        } }, "Theme"),
                    React.createElement(Text, { id: "accent-color-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Accent color"),
                    React.createElement("div", { style: {
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "accent-color-title" }, themeAccentColorsOrdered.map((color) => (React.createElement("label", { key: color, className: "fui-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(Tooltip, { content: `${upperFirst(color)}${accentColor === 'gray' && resolvedGrayColor !== 'gray'
                                ? ` (${upperFirst(resolvedGrayColor)})`
                                : ''}` },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "accentColor", value: color, checked: accentColor === color, onChange: (event) => onAccentColorChange(event.target.value) })))))),
                    React.createElement(Text, { as: "p", id: "gray-color-title", size: "2", weight: "medium", style: {
                            marginTop: 24,
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    React.createElement("div", { style: {
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "gray-color-title" }, ['auto', 'gray', ...radixGrayScalesDesaturated].map((gray) => (React.createElement("label", { key: gray, className: "fui-ThemePanelSwatch", style: {
                            display: 'flex',
                            alignItems: 'center',
                        ...
                        React.createElement(Tooltip, { content: `${upperFirst(gray)}${gray === 'auto' ? ` (${upperFirst(autoMatchedGray)})` : ''}` },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "grayColor", value: gray, checked: grayColor === gray, onChange: (event) => onGrayColorChange(event.target.value) })))))),
                    React.createElement(Text, { id: "info-color-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Info color"),
                    React.createElement("div", { style: {
                            display: 'grid',
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "info-color-title" }, infoColors.map((color) => (React.createElement("label", { key: color, className: "fui-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(Tooltip, { content: upperFirst(color) },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "infoColor", value: color, checked: infoColor === color, onChange: (event) => onInfoColorChange(event.target.value) })))))),
                    React.createElement(Text, { id: "success-color-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Success color"),
                    React.createElement("div", { style: {
                            display: 'grid',
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "success-color-title" }, successColors.map((color) => (React.createElement("label", { key: color, className: "fui-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(Tooltip, { content: upperFirst(color) },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "successColor", value: color, checked: successColor === color, onChange: (event) => onSuccessColorChange(event.target.value) })))))),
                    React.createElement(Text, { id: "warning-color-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Warning color"),
                    React.createElement("div", { style: {
                            display: 'grid',
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "warning-color-title" }, warningColors.map((color) => (React.createElement("label", { key: color, className: "fui-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(Tooltip, { content: upperFirst(color) },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "warningColor", value: color, checked: warningColor === color, onChange: (event) => onWarningColorChange(event.target.value) })))))),
                    React.createElement(Text, { id: "danger-color-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Danger color"),
                    React.createElement("div", { style: {
                            display: 'grid',
                            ...
                            gap: 'var(--space-2)',
                            marginTop: 12,
                        }, role: "group", "aria-labelledby": "danger-color-title" }, dangerColors.map((color) => (React.createElement("label", { key: color, className: "fui-ThemePanelSwatch", style: { backgroundColor: `var(--${color}-9)` } },
                        React.createElement(Tooltip, { content: upperFirst(color) },
                            React.createElement("input", { className: "fui-ThemePanelSwatchInput", type: "radio", name: "dangerColor", value: color, checked: dangerColor === color, onChange: (event) => onDangerColorChange(event.target.value) })))))),
                    React.createElement(Text, { id: "appearance-title", as: "p", size: "2", weight: "medium", style: {
                            marginTop: 24,
                        } }, "Appearance"),
                    React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 'var(--space-2)', marginTop: 12 }, role: "group", "aria-labelledby": "appearance-title" }, ['light', 'dark'].map((value) => (React.createElement("label", { key: value, className: "fui-ThemePanelRadioCard" },
                        React.createElement("input", { className: "fui-ThemePanelRadioCardInput", type: "radio", name: "appearance", value: value, checked: resolvedAppearance === value, 
